...
public class CoursesParent extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null && bundle.containsKey("filter")){
            ...
            getCourses(Consts.COURSES_FILTER + bundle.getString("filter"));
        }
        else {

            getCourses(Consts.COURSES);
        }
...
//        coursesRV.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));
    ...
    private void getCourses(String url){
